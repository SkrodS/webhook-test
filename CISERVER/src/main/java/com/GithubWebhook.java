...
public class GithubWebhook extends HttpServlet {
     ...
     */
            ...
            workspace.mkdirs();
            System.out.println("Workspace directory: " + workspace.getAbsolutePath());
            try {
                ...
                System.out.println("Git clone output:\n" + cloneResult.getOutput());
                ...
                System.out.println("Git checkout output:\n" + checkoutResult.getOutput());
    ...
    protected void runCompilePhase(File workspace) throws Exception {
        ...
        ProcessBuilder pb = new ProcessBuilder("mvn", "-B", "-f", new File(workspace, "pom.xml").getAbsolutePath(), "clean", "compile");
    ...
    protected void runTestPhase(File workspace) throws Exception {
        ...
        ProcessBuilder pb = new ProcessBuilder("mvn", "-B", "-f", new File(workspace, "pom.xml").getAbsolutePath(), "clean", "test");
        pb.directory(workspace);
